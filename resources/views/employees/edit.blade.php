        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <select id="cars" name="dept_id">
                        @foreach($departments as $department)
                            {
                            <option value="{{$department->id}}" <?php if($department->id==$employee->dept_id){echo 'selected';}?>>{{$department->department}}</option>
                            }
                        @endforeach
                    </select>
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <select id="cars" name="design_id">
                    @foreach($designations as $designation)
                            {
                            <option value="{{$designation->id}}" <?php if($designation->id==$employee->design_id){echo 'selected';}?>>{{$designation->designation  }}</option>
                            }
                        @endforeach
                    </select>
                </div>
